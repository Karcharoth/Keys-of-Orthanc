...
EFFECT(TERRAIN_BEAM,					true,	NULL,   1,		EFINFO_PROJ,	"casts a beam of %s",			"cast a beam of %s")
...
EFFECT(RESTORE_STAMINA,				false,	NULL,		0,		EFINFO_NONE,	"restores some stamina",	"restore some stamina")
