...
RSF(ARROW3,		RST_INNATE | RST_ARCHERY | RST_DISTANT)
RSF(TENTACLE,	RST_INNATE | RST_ARCHERY | RST_DISTANT)
RSF(BOULDER,	RST_INNATE | RST_ARCHERY | RST_DISTANT)
RSF(BOMB,   	RST_INNATE | RST_ARCHERY | RST_DISTANT)
